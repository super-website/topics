'use client'
import { createPapers, createPdf, getClass } from '@/utils/actions'
...
export default function UploadPaper() {
  ...
  return (
    <div>
      <form action={createPapers} method='post'>
        <h1 className='text-2xl font-semibold'>Add Paper</h1>
        ...
        <div>
          <label className='block mb-2 text-gray-700 font-semibold'>
            📄 Upload PDF (File must be less than or equal to 10MB)
          </label>
          <div
